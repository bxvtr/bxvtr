...
Linux, OCI, Terraform, Ansible, Kubernetes / MicroK8s, Argo CD, Helm, and Kustomize

**Operations & Observability**
Prometheus, Grafana, reconciliation, failure drills, and artifact-backed operational evidence

**Systems & Networking**
Rust, Python, Bash, async WebSockets, NetworkManager, firewalld, and WireGuard

**Data & Platform Infrastructure**
PostgreSQL, TimescaleDB, SQLAlchemy, MLflow, market-data clients, and simulation/runtime integration

**Testing & Documentation**
pytest, integration testing, Ruff, validation tooling, Sphinx, MkDocs, ADRs, and Docs-as-Code

**Development & Delivery**
Docker, Docker Compose, Git, GitHub Actions, Dev Containers, and GitOps workflows
...
<p>
  <img
    ...
    height="36"
    title="Linux, Docker, Kubernetes, Terraform, Ansible, Rust, Python, Bash, PostgreSQL, Prometheus, Grafana, Git, and GitHub Actions"
    alt="Linux, Docker, Kubernetes, Terraform, Ansible, Rust, Python, Bash, PostgreSQL, Prometheus, Grafana, Git, and GitHub Actions"
  />
</p>
